...
This directory contains code and documentation for the [Multiple Rare-variants and Phenotypes Mixture Model](https://www.biorxiv.org/content/10.1101/2021.08.03.454967v2) by Venkataraman *et. al.*. The repository is maintained by Guhan Ram Venkataraman (GitHub: guhanrv).
